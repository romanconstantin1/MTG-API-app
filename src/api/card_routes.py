    ...
    if "card_faces" in data:
        ...
        response = {
            "card_front" : {
                ...
                "cmc": data["cmc"],
                "colors": front_card_entry["colors"],
